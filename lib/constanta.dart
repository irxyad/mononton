...
const Color secondaryColor = Color(0xFF1E1E2F);
const Color primaryColor = Color(0xFFC91C1C);
const Color black = Color(0xFF151515);
const Color grey = Color(0xFF888888);
const Color darkGrey = Color(0xFF3D3D3D);
